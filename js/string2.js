class String {
    constructor(){
        ...
        this.gain = new Tone.Gain(0.05);
        this.loopGain = new Tone.Gain(0.5);
        this.outputGain = new Tone.Gain();

        // Might be better at the end of the signal chain - peak filter.
        ...
        this.outputFilter = new Tone.Filter({
            type: 'lowpass',
            frequency: 30
        })
        ...
        this.loopGain.connect(this.loopFilter);
        this.loopFilter.connect(this.delay);
        this.loopFilter.connect(this.outputFilter);
